...
The current UI is one substantial school: Enchantment/group theory, with ten folios and one shared cantrip folio. It replaces the prototype's seven toy school examples. Catalog generated by [[graduate-grimoire]]; not handwritten in UI. Default is first-isomorphism, or a known folio ID from the URL fragment.
