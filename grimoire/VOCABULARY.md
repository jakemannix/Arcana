...
| Lean model | Spell name | Mathematical interpretation |
|---|---|---|
| `cyclicSix` | Sixfold Wheel | C₆, generated by one turn |
| `kleinFour` | Klein's Forked Charm | C₂ × C₂, two independent toggles |
| `squareSymmetries` | Four Winds Veyr | D₄, the eight symmetries of a square |
| `pentagramSymmetries` | Five Pointed Seal | D₅, the ten symmetries of a regular pentagram |
| `cyclicEight` | Eightfold Wheel | C₈ |
| `fourTimesTwo` | Twin Fourfold Wheels | C₄ × C₂, two copies of a four-cycle |
| `threeToggles` | Three Mirror Charms | C₂ × C₂ × C₂ |
| `quaternionEight` | Hamilton's Eightfold Pact | Q₈, the finite unit quaternion group |
